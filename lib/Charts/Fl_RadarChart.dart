              ...
              children: rawDataSets()
                ...
                return MapEntry(
                  ...
                  GestureDetector(
                    ...
                    child: DevValueBox(isSelected: isSelected, value: value,)
                  ),
                );
              })
                  .values
                ...
                RadarChartData(
                  ...
                  getTitle: (index, angle) {
                    ...
                    switch (index) {
                      ...
                      case 1:
                        return RadarChartTitle(text: 'East', angle: usedAngle);
                      case 2:
                        return RadarChartTitle(text: 'South', angle: usedAngle);
                      default:
                  ...
                  gridBorderData: BorderSide(color: widget.gridColor, width: 1),
                ),
...
class DevValueBox extends StatelessWidget {
  DevValueBox({
    super.key,
      ...
      child: Row(
        ...
        children: [
          ...
          AnimatedDefaultTextStyle(
            ...
            style: TextStyle(
              color:
              isSelected ? value.color : AppColors.contentColorPurple.lighten(80),
            ),
